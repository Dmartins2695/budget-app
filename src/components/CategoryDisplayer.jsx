import { Card, CardActions, CardContent, CardHeader, CardMedia, Collapse, styled, Typography } from '@mui/material'
...
export const CategoryDisplayer = (props) => {
  const { name, budget, balance, items } = props
